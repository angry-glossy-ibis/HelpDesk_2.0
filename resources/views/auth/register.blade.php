            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="telename" class="col-md-4 col-form-label text-md-right">{{ __('Tele Name') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="role_id" class="col-md-4 col-form-label text-md-right">{{ __('') }}</label>

                            <div class="col-md-6">
                              <input id="role_id" type="hidden" class="form-control{{ $errors->has('role_id') ? ' is-invalid' : '' }}" name="role_id" value="{{ '1' }}" required autofocus>
                          ...
                          <div class="form-group row">
                              <label for="position_id" class="col-md-4 col-form-label text-md-right">{{ __('') }}</label>

                              <div class="col-md-6">
                                <input id="position_id" type="hidden" class="form-control{{ $errors->has('position_id') ? ' is-invalid' : '' }}" name="position_id" value="{{ '2' }}" required autofocus>
