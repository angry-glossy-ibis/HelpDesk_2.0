...
<div class="row">
  ...
  <div class="row">
    ...
    <div class="form-group">
      ...
      {{ Form::text('ClientSurname', $cliens1->ClientSurname, ['class' => 'form-control', 'disabled']) }}
    </div>
    <div class="form-group">
      {{ Form::label('ClientName', __('Имя')) }}
      {{ Form::text('ClientName', $cliens1->ClientName, ['class' => 'form-control', 'disabled']) }}
    </div>
    <div class="form-group">
      {{ Form::label('ClientPatronymic', __('Отчество')) }}
      {{ Form::text('ClientPatronymic', $cliens1->patronymic, ['class' => 'form-control', 'disabled']) }}
    </div>
    <div class="form-group">
      {{ Form::label('ClientMail', __('почта')) }}
      {{ Form::text('ClientMail', $cliens1->ClientMail, ['class' => 'form-control', 'disabled']) }}
    </div>
  </div>
  <div class="row">
    <div class="col-md-1">
    ...
    <div class="form-group">
      ...
      {{ Form::text('ClientPhone', $cliens1->ClientPhone, ['class' => 'form-control', 'disabled']) }}
    </div>
    <div class="form-group">
